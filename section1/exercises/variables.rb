...
# Explain.
# The first name seemed obvious enough, I wasn't sure about the "is_hungry", but it seemed like a true/false event
# and the last one seemed like a number would be best.
