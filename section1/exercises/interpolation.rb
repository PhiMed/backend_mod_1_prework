...
trash_pandas = "racoons"
danger_noodles = "Western Diamondback Rattlesnakes"
jerks = "Canada geese"

puts "In the foothills of the Rocky Mountains, one can find a variety of fauna, to include #{trash_pandas}, #{danger_noodles}, and #{jerks}."
